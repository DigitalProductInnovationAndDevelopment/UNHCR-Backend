...
from EndUserManagement.serializers.inputValidators import UserDeviceUpdateValidator
from EndUserManagement.serializers.responseSerializers import UserDeviceGetResponseSerializer
...
def userDeviceDetailController(request, id, **kwargs):
    ...
    if request.method == "GET":
        ...
        try:
            ...
            responseSerializer = UserDeviceGetResponseSerializer(userDevice)
            return Response(
        ...
        try:
            ...
            bodyParamsValidator = UserDeviceUpdateValidator(data = bodyParams)
