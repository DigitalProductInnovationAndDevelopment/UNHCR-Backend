...
urlpatterns = [
    ...
    path("api/messages/<str:messageId>/message-media/<str:mediaId>/transcription/<str:transcriptionId>", messageMediaTranscriptionDetailController, name="messageMediaDetail"),
    path("api/cases/<str:caseId>/case-media/<str:mediaId>/transcription/<str:transcriptionId>", caseMediaTranscriptionDetailController, name="caseMediaDetail"),
